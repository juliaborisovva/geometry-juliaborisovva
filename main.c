...
Bool check_punctuation_symbols(
        char** cursor_start, /*int* implementation,*/ char symbol)
{
...
Type determine_figure(
        char** cursor_start,
        /*int* implementation, */ size_t length_of_type,
        char* type_circle,
        char* type_triangle)
{
...
Bool parse_circle(char** cursor_start, char** cursor_end, int* counter)
{
    ...
    *cursor_start = *cursor_end;
    ...
    implementation2 = check_punctuation_symbols(
            &(*cursor_start), /*&(*implementation),*/ ',');
...
int main()
{
    ...
    while ((fgets(input, 70, stdin))) {
        ...
        cursor_start = cursor_end;
        skip_space(&cursor_start);
        implementation = check_punctuation_symbols(
                &cursor_start, /*&implementation, */ '(');
